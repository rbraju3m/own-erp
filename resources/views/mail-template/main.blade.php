...
{{--                                            <a href="{{ url('/login') }}"><img src="{{asset('sitesetting_images/thumb/'.$siteSetting->site_logo)}}" /></a>--}}
                                            <h3>{{ 'Lazycoders Ltd' }}</h3>
                                        </td>
                                        {{--<td>{{$siteSetting->site_logo}}</td>
...
{{--                                    @include('admin.layouts.email_template_social')--}}
                                ...
                                <br>
                                <span class="ios-footer" style=" text-align:center;display: block;"> © Copyright {{ date('Y')}} {{ config('app.company_name') }} - All Rights Reserved </span> <br>
                                <br></td>
                        </tr>
                    </table>
                    <!--/600px container --></td>

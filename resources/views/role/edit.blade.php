            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::model($role, ['method' => 'PATCH','autocomplete'=>'off', 'files'=> true, 'route'=> ['role_update', app()->getLocale(), $role->id],"class"=>"",'enctype'=>'multipart/form-data', 'id' => 'basic-form']) !!}
                        ...
                        <div class="row">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('name',$role->name,['id'=>'name','class' => 'form-control','Placeholder' => __('messages.PlcRoleName')]) !!}
                                    ...
                                    @foreach($permission as $value)
                                        <ul class="untitle-list">
                                            <li class="listStyleNone">
                                                {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name','id'=>$value->name)) }}

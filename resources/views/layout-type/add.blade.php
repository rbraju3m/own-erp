...
{{--                                            <span class="textRed">*</span>--}}
                                    ...
                                    <div class="form-group row mg-top">
                                        ...
                                        {{--<div class="col-sm-4">
                                            {!! Form::select('country_id',$countries,19,['id'=>'country_id','class' => 'form-control form-select js-example-basic-single','placeholder'=>__('messages.selectCountry')]) !!}
...
--}}{{--                                            <span class="textRed">*</span>--}}{{--
                                    ...
                                    <div class="form-group row mg-top">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            {{--{!! Form::select('designation_id',$designation,'',['id'=>'designation_id','class' => 'form-control form-select js-example-basic-single','placeholder'=>__('messages.selectDesignation')]) !!}
                                        ...
                                        <div class="col-sm-3">
                                           {{-- {!! Form::select('location_id',$location,'',['id'=>'location_id','class' => 'form-control form-select js-example-basic-single','placeholder'=>__('messages.selectLocation')]) !!}
...
{{--                                            <span class="textRed">*</span>--}}
                                        ...
                                        <div class="col-sm-3">
                                           {{-- {!! Form::select('department_id',$department,'',['id'=>'department_id','class' => 'form-control form-select js-example-basic-single','placeholder'=>__('messages.selectDepartment')]) !!}
                                    ...
                                    <div class="form-group row mg-top">
                                        <div class="col-sm-2">
                                            {!! Form::label(__('messages.signature'), __('messages.signature'), array('class' => 'form-label','for'=>'formFile')) !!}
                                        </div>
